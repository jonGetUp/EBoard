 ...
 * Date: 05.08.17
 * Infos: nRF24L01-Transmitter,
 * Le code suivant contrôle un Servo-Moteur sur la pin2 d'après les informations reçu par la télécommande (Freiner, Maintenir, Accelérer). Une détection d'erreur est également intégrée.
*/
#include ....
//Prototypes
int StateChange(int input);
//Pin affectation
int IN=0;	//Instruction from the remote controler
int ESC=0; 	//ElectronicSpeedControler command
...
enum{Init, Hold, Acc, Error, Fail, Wait};
state=Init;
while(1)
{
	//Reception IN=...
...
//In function of the inpout this fonction jump between the 3 main states and detect errors
int stateChange(int input)
{
	switch (input)
	{	
