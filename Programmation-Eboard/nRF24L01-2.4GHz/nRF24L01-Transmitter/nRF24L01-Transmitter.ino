 ...
 * Date: 04.08.17
 * Infos: nRF24L01-Transmitter,/!\ alimentation
 * Le code suivant contrôle un servo moteur grâce à un module radio, avec deux boutons: Z "Acceleration" C "Hold the speed"
*/
#include ....
//Pin affectation
int X=ADC2;  //analogPin (0-1023)
int Y=ADC3;  //analogPin (0-1023)
int Z=PB2;   //btn autorise the acceleration
int C=PB0;   //btn maintain the speed
int OUT=MISO; //Remote control output(MasterIn-SlaveOut)
				//IRQ->Basse consomation
